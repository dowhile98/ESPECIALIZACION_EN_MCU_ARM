...
#                        of executable (1/0)?
MODEL                = STM32_MAT
MODULES              = STM32_MAT_EXTI.c STM32_MAT_TIM.c main.c stm32xxxx_it.c
MODULES_OBJ          = STM32_MAT_EXTI.obj STM32_MAT_TIM.obj main.obj stm32xxxx_it.obj 
MAKEFILE             = STM32_MAT.mk
...
MODELLIB                  = 
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = STM32_MAT_ref.rsp
...
# Additional includes
ADD_INCLUDES = \
 -ID:/TRABAJO/UMAKER/CURSOS/ARM - NUCLEO/ESPECIALIZACION_EN_MCU_ARM/Codigo/STM32-MAT  -ID:/TRABAJO/UMAKER/CURSOS/ARM - NUCLEO/ESPECIALIZACION_EN_MCU_ARM/Codigo/STM32-MAT/STM32_MAT_stm32  -I$(MATLAB_ROOT)/extern/include  -I$(MATLAB_ROOT)/simulink/include  -I$(MATLAB_ROOT)/rtw/c/src  -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common  -I$(MATLAB_ROOT)/rtw/c/ert  -IC:/MATLAB/STM32-MAT/STM32/addSrc/inc 
